...
# nombre de journalistes dans la liste
...
# nombre de journalistes avec un numéro

def num 
    puts "Il y a #{journalists.count { |x| x.downcase.include?("0") || 

                        x.downcase.include?("1") ||

                        x.downcase.include?("2") || 

                        x.downcase.include?("3") || 

                        x.downcase.include?("4") || 

                        x.downcase.include?("4") || 

                        x.downcase.include?("5") || 

                        x.downcase.include?("6") || 

                        x.downcase.include?("7") || 

                        x.downcase.include?("8") || 

                        x.downcase.include?("9")

}} handles qui contiennent un numéro."
end

puts num

# nombre de handle avec "aude" dedans

def aude 
    puts "Il y a #{journalists.count { |x| x.downcase.include? 'aude'}} handles qui commmencent par Aude."
end 

puts aude 

# nombre de handle contenant une majuscule

def gotmaj
    puts "Il y a #{journalists.count { |x| x =~ /[A-Z]/ }} handles qui contiennent une majuscule."
end

puts gotmaj

# nombre de handle avec "underscore" dedans

def undescore
    puts "Il y a #{journalists.sum { |s| s.count('_') }} handles avec un underscore."
end
...
def startmaj 
    puts "Il y a #{journalists.count { |x| x=~ /^@[A-Z]/ }} handles ont un @ suivi d'une majuscule."
end
